        ...
        <section className="py-24 overflow-x-clip">
            <div className="container relative">
                ...
                <div className="flex justify-center">
                    <div className="inline-flex py-1 px-3 rounded-full text-neutral-950 font-semibold bg-gradient-to-r from-purple-400 to-pink-400 bg-[length:200%_200%] bg-[position:0%_50%] animate-gradientMove">
