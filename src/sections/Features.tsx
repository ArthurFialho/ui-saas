                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 text-center">
                                We`ve achieved
                                <span className=" bg-gradient-to-r from-purple-400 to-pink-400 bg-[length:200%_200%] bg-[position:0%_50%] animate-gradientMove transition-transform duration-500 bg-clip-text text-transparent">
                                    {" "}
                                    incredible
                                </span>{" "}
                                growth this year
