            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            <p className="text-4xl font-extrabold text-white/20 group-hover:text-white/10 transition duration-500 text-center">
                                We&apos;ve achieved{" "}
                                <span className=" bg-gradient-to-r from-purple-400 to-pink-400 bg-[length:200%_200%] bg-[position:0%_50%] animate-gradientMove transition-transform duration-500 bg-clip-text text-transparent relative">
                    ...
                    <FeatureCard
                        ...
                        className="md:col-span-2 lg:col-span-1 md:col-start-2 border-2 border-transparent lg:col-start-auto group hover:border-neutral-400 transition duration-500"
                    >
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        ...
                        >
                            <span className="bg-lime-400 text-neutral-950 size-5 rounded-full inline-flex items-center justify-center text-xl group-hover:rotate-[130deg] group-hover:bg-lime-500 transition duration-500">
                                &#10038;
                            </span>
